...
app('Acceptance | admin/team-settings/user fields/edit', {
  beforeEach() {
...
test('editing a text field', function(assert) {
  ...
  andThen(function() {
    ...
    click(`div .${checkboxStyles.checkboxWrap}:contains(This field is required for customers) div`);
  ...
  andThen(function() {
    ...
    findWithAssert(`div .${checkboxStyles.checkboxWrap}:contains(Customers can edit this field) div[aria-checked=true]`);
    findWithAssert(`div .${checkboxStyles.checkboxWrap}:contains(This field is required for customers) div[aria-checked=true]`);
...
test('cancel editing a text field', function(assert) {
  visit('/admin/customizations/user-fields');
  ...
  andThen(function() {
    ...
    findWithAssert(`div .${checkboxStyles.checkboxWrap}:contains(Customers can edit this field) div[aria-checked=true]`);
    findWithAssert(`div .${checkboxStyles.checkboxWrap}:contains(This field is required for customers) div[aria-checked=false]`);
