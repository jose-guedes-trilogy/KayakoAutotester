        ...
        - generic [ref=e140]:
          ...
          - generic [ref=e170]:
            ...
            - generic [ref=e174]:
              - generic [ref=e175]:
                - generic [ref=e177]:
                  - 'button "Conversations: Status " [ref=e180] [cursor=pointer]':
                    - generic [ref=e181]:
                      - generic [ref=e182]: "Conversations: Status"
                      - generic [ref=e183]: 
                  - button "equal to " [active] [ref=e186] [cursor=pointer]:
                    - generic [ref=e187]:
                      - generic [ref=e188]: equal to
                      - generic [ref=e189]: 
                  - button "" [ref=e192] [cursor=pointer]:
                    - generic [ref=e194]: 
                - generic [ref=e195] [cursor=pointer]: + Add a new condition
              - generic [ref=e196] [cursor=pointer]: +And
          - generic [ref=e197]:
            - heading "Perform the following actions" [level=5] [ref=e198]
            - paragraph [ref=e199]: If the conditions match, the rule will fire and the actions will be executed. Note that any conversation update actions, such as changing the priority of a conversation, will take place before any notifications are sent out.
            - generic [ref=e200]:
              - article [ref=e201]:
                - button "Select an action " [ref=e204] [cursor=pointer]:
                  - generic [ref=e205]:
                    - generic [ref=e206]: Select an action
                    - generic [ref=e207]: 
              - generic [ref=e208] [cursor=pointer]: + Add a new action
          - generic [ref=e211]:
            - button "Cancel" [ref=e212] [cursor=pointer]:
              - generic [ref=e213]: Cancel
            - button "Save" [ref=e214] [cursor=pointer]:
              - generic [ref=e215]: Save
```