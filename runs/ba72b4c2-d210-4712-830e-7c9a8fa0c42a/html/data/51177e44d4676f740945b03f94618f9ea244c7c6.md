              ...
              - generic [ref=e175]:
                - generic [ref=e177]:
                  ...
                  - button "" [ref=e192] [cursor=pointer]:
                    - generic [ref=e194]: 
                - generic [ref=e196] [cursor=pointer]: + Add a new condition
              - generic [ref=e197] [cursor=pointer]: +And
          - generic [ref=e198]:
            - heading "Perform the following actions" [level=5] [ref=e199]
            - paragraph [ref=e200]: If the conditions match, the rule will fire and the actions will be executed. Note that any conversation update actions, such as changing the priority of a conversation, will take place before any notifications are sent out.
            - generic [ref=e201]:
              - article [ref=e202]:
                - button "Select an action " [ref=e205] [cursor=pointer]:
                  - generic [ref=e206]:
                    - generic [ref=e207]: Select an action
                    - generic [ref=e208]: 
              - generic [ref=e209] [cursor=pointer]: + Add a new action
          - generic [ref=e212]:
            - button "Cancel" [ref=e213] [cursor=pointer]:
              - generic [ref=e214]: Cancel
            - button "Save" [ref=e215] [cursor=pointer]:
              - generic [ref=e216]: Save
```